...
public class Ship extends Entity {
    ...
    public void update() {
        ...
        double dx = stats.getSideSpeedModifier() * speed * delta * Math.cos(Math.toRadians(Gdx.input.getRoll()-90))/1080.0;
        double dy = stats.getFrontSpeedModifier() * speed * delta * Math.sin(Math.toRadians(Gdx.input.getPitch()))/1920.0;
