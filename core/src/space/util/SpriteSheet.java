...
public class SpriteSheet {    
    ...
    public static SpriteSheet SHIP_VARIANT_1 = new SpriteSheet("ship_spritesheet1.png",32,32);
    public static SpriteSheet SHIP_VARIANT_2 = new SpriteSheet("ship_spritesheet2.png",32,32);
